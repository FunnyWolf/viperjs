export default {
  ...
  'app.payloadandhandler.rc4password_rule': '请输入RC4协议密码,建议在8位以上',
  ...
  'app.payloadandhandler.AutoVerifySessionTimeout': '加载超时时间',
  ...
  'app.payloadandhandler.SessionCommunicationTimeout': '连接超时时间(秒)',
  'app.payloadandhandler.SessionCommunicationTimeout_ph': '请输入正确的连接超时时间',
  'app.payloadandhandler.SessionExpirationTimeout': 'Session强制过期时间(秒)',
  'app.payloadandhandler.SessionExpirationTimeout_ph': '请输入正确的强制过期时间',
  'app.payloadandhandler.proxies_proto': '代理配置',
  'app.payloadandhandler.proxies_proto_tip': '正向监听会通过填写的代理进行连接,反向Payload无法使用代理',
  ...
  'app.payloadandhandler.ADD_HANDLER_tip': '生成载荷同时添加对应的监听(生成的监听无法使用代理,无法设置为永久监听,请手工点击刷新按钮刷新)',
  ...
  'app.payloadandhandler.getreal': '实例化',
  'app.payloadandhandler.getvirl': '虚拟化',
