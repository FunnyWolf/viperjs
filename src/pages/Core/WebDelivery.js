...
import { deleteMsgrpcWebDeliveryAPI, getCoreSettingAPI, getMsgrpcWebDeliveryAPI, postMsgrpcWebDeliveryAPI } from "@/services/apiv1";
import { Button, Card, Checkbox, Col, Collapse, Descriptions, Form, Input, InputNumber, Popover, Row, Select, Space, Table, Typography } from 'antd-v5';
...
const CreateWebDeliveryModalContent = props => {
  ...
  const webDevliverServerOption = () => {
    ...
    options.push(<Form.Item
      ...
      rules={[
        {
          required: true, message: formatText("app.webdelivery.URIHOST.rule"),
        }]}
    >
