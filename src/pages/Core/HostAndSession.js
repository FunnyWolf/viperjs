            ...
            },
            {
                ...
                render: (text, sessionRecord) => {
                    ...
                    if (session.available === true && session.isadmin === true) {
                        user = (
                            <Tooltip mouseEnterDelay={1} placement="bottomLeft" title={session.info}>
                                <Tag
                                    color="orange"
                                    style={{
                                        marginLeft: -6,
    ...
    return (
        <Fragment>
            ...
            <Table
                ...
                style={{
                    overflow: "auto",
                    minHeight: cssCalc(`${resizeUpHeight}`),
                    maxHeight: cssCalc(`${resizeUpHeight}`)
                }}
                rowKey="ipaddress"
                size="small"
                locale={{ emptyText: null }}
                ...
                <TabPane
                    tab={
                        <div className={styles.tabPanediv}>
                            <CustomerServiceOutlined />
                            <span
                                className={styles.tabPanespan}>{formatText("app.hostandsession.tab.PayloadAndHandler")}</span>
                        </div>
                    }
                ...
                <TabPane
                    tab={
                        <div className={styles.tabPanediv}>
                            <KeyOutlined />
                            <span
                                className={styles.tabPanespan}>{formatText("app.hostandsession.tab.Credential")}</span>
                        </div>
                    }
                    key="Credential"
                >
                ...
                <TabPane
                    tab={
                        <div className={styles.tabPanediv}>
                            <MonitorOutlined />
                            <span
                                className={styles.tabPanespan}>{formatText("app.hostandsession.tab.passivescan")}</span>
                        </div>
                    }
                    key="ProxyHttpScan"
                >
                ...
                <TabPane
                    tab={
                        <div className={styles.tabPanediv}>
                            <SettingOutlined />
                            <span
                                className={styles.tabPanespan}>{formatText("app.hostandsession.tab.SystemSetting")}</span>
                        </div>
                    }
                    key="SystemSetting"
                >
        ...
        <Fragment>
            ...
            >
                ...
                <Form.Item
                    ...
                    name="subnet"
                    rules={[{
                        required: !autoRouteCheck,
                        message: formatText("app.hostandsession.msfroute.subnet.rule")
                    }]}
                >
                ...
                <Form.Item
                    ...
                    rules={[{
                        required: !autoRouteCheck,
                        message: formatText("app.hostandsession.msfroute.netmask.rule")
                    }]}
                >
                    <Input style={{ width: 240 }} disabled={autoRouteCheck}
