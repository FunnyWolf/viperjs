...
const Credential = () => {
  ...
  return (<Fragment>
    ...
    <Table
      ...
      columns={[
        {
          title: formatText("app.credential.username"), dataIndex: "username", key: "username",

          render: (text, record) => (<Ellipsis tooltip lines={2}>
            {text}
          </Ellipsis>),
        }, {
          ...
          title: formatText("app.credential.tag"), dataIndex: "tag", key: "tag", render: (text, record) => (<Ellipsis tooltip lines={2}>
            {getOptionTag(record)}
          </Ellipsis>),
        }, {
          title: formatText("app.credential.sourcemodule"), dataIndex: "source_module", key: "source_module", render: (text, record) => {
            const test = text;
