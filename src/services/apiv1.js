...
export async function getWebdatabaseClueFaviconAPI(params) {
  return request('/api/v1/webdatabase/cluefavicon/', {
    params,
  });
}

export async function postWebdatabaseClueFaviconAPI(params) {
  return request('/api/v1/webdatabase/cluefavicon/', {
    method: 'POST',
    data: params,
  });
...
export async function deleteWebdatabaseClueFaviconAPI(params) {
  return request('/api/v1/webdatabase/cluefavicon/', {
    method: 'DELETE',
    params,
  });
...
export async function deleteWebdatabaseClueCompanyAPI(params) {
  return request('/api/v1/webdatabase/cluecompany/', {
    method: 'DELETE',
    params,
  });
